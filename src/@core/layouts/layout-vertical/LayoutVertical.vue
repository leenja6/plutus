<template>
  ...
  >
    ...
    <b-navbar
      ...
      class="header-navbar navbar navbar-shadow align-items-center navbar-expand"
...
import AppChat from '@/components/chatmini/AppChat.vue'
...
export default {
  ...
  setup() {
    ...
    const boxchat = ref()
    onMounted(() => {
      store.commit('viewschats/chatHeight', heightbox.value.clientHeight)
    })
